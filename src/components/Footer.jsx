...
const Footer = () => {
  ...
  const eventLinks = [
    ...
    { name: 'Parachute', href: '#events' },
    { name: 'Aircraft Investigation', href: '#events' },
    { name: 'Design Parameters', href: '#events' },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            {/* Faculty Coordinator */}
            <div className="mb-4">
              <p className="text-electric text-xs font-semibold uppercase tracking-wider mb-2">Faculty Coordinator</p>
              <div className="text-steel text-sm">
                <p className="text-white font-medium">Mr. Parthasarathy</p>
                <p className="text-xs text-steel">Asst. Professor - Aeronautical Engineering</p>
                <a href="tel:+919629553585" className="flex items-center gap-2 mt-1 hover:text-electric transition-colors">
                  <Phone className="w-4 h-4" />
                  <span>96295 53585</span>
                </a>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-3">
                <div className="text-steel text-sm">
                  <p className="text-white font-medium">Yash Naik <span className="text-steel text-xs">(3rd Year)</span></p>
                ...
                <div className="text-steel text-sm">
                  <p className="text-white font-medium">Md Ammar <span className="text-steel text-xs">(2nd Year)</span></p>
                  <a href="tel:+918073729573" className="flex items-center gap-2 mt-1 hover:text-electric transition-colors">
                    <Phone className="w-4 h-4" />
                    <span>80737 29573</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            <motion.a
              href="https://wa.me/919324286177?text=Hi%2C%20I%27m%20interested%20in%20Xcelerate%202026"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="mt-2 flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white font-semibold py-2.5 px-4 rounded-lg transition-colors text-sm w-full justify-center"
            >
