...
const Footer = () => {
  ...
  const eventLinks = [
    { name: 'Drone Flying Competition', href: '#events' },
    { name: 'Egg Parachute Competition', href: '#events' },
    { name: 'Aircraft Accident Investigation', href: '#events' },
    { name: 'Aircraft Designing & Sketching', href: '#events' },
    { name: 'Aircraft Poster Presentation', href: '#events' },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <motion.a
              href="https://chat.whatsapp.com/FoDRug6F4ubLsJ7anTJV0m"
              target="_blank"
              rel="noopener noreferrer"
