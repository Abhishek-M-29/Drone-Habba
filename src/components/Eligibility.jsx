          ...
          <div className="relative grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <motion.div
                ...
                viewport={{ once: true }}
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-gray-300 text-xs font-bold uppercase tracking-wider mb-6"
              >
              ...
              >
                Open to <span className="text-white">All Students</span> Across India
              </motion.h2>
            ...
            <motion.div 
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-gray-500 via-gray-600 to-orange-alert rounded-2xl blur-xl opacity-15" />
              <div className="bg-space-100 border border-slate-border rounded-2xl p-8 relative">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-space-200 rounded-xl p-6 text-center border border-slate-border group hover:border-gray-600 transition-colors">
                    <div className="w-12 h-12 mx-auto bg-white/10 rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                  ...
                  <div className="col-span-2 bg-gradient-to-r from-white/5 to-transparent rounded-xl p-6 flex items-center gap-4 border border-white/10">
                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg shadow-white/10">
