          ...
          <div className="flex flex-wrap gap-4 mb-8 pb-6 border-b border-slate-border">
            ...
            {event.registrationFee && (
              <div className="flex items-center gap-2 bg-slate-card px-4 py-2 rounded-lg">
                ...
                <span className="text-steel-light text-sm font-medium">Fee: {event.registrationFee}</span>
              </div>
            )}
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-slate-border">
            {event.whatsappLink && (
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-500 text-white font-semibold py-3 px-6 rounded-xl transition-colors flex-1 text-center"
              >
